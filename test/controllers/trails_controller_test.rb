...
class TrailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trail" do
    assert_difference("Trail.count") do
      post trails_url, params: { trail: { comment: @trail.comment, complexity: @trail.complexity, name: @trail.name, surface: @trail.surface } }
    end
  ...
  test "should update trail" do
    patch trail_url(@trail), params: { trail: { comment: @trail.comment, complexity: @trail.complexity, name: @trail.name, surface: @trail.surface } }
